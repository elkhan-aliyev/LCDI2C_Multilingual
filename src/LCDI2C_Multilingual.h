/*
  ** LCDI2C_Multilingual header **
  All classes for printing multilingual
  UTF-8 strings (NFC normalized) to I2C LCD.  
  You can include this whole header file or each separate header files
  for language compositions used in your program
